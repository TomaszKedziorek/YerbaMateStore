            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Discriminator = table.Column<string>(type: "longtext", nullable: false)
                        .Annotation("MySql:CharSet", "utf8mb4"),
                    ProductOrderDetailBombilla_ProductId = table.Column<int>(name:"BombillaProductId", type: "int", nullable: true),
                    ProductOrderDetailCup_ProductId = table.Column<int>(name: "CupProductId", type: "int", nullable: true),
                    ProductOrderDetailYerbaMate_ProductId = table.Column<int>(name: "YerbaMateProductId", type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        column: x => x.ProductOrderDetailBombilla_ProductId,
