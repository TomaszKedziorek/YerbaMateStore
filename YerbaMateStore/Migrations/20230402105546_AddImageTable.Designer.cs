...
namespace YerbaMateStore.Migrations
{
    ...
    [Migration("20230402105546_AddImageTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("YerbaMateStore.Models.Entities.Image", b =>
                {
                    b.HasOne("YerbaMateStore.Models.Entities.BombillaProduct", null)
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YerbaMateStore.Models.Entities.CupProduct", null)
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("YerbaMateStore.Models.Entities.YerbaMateProduct", null)
                        .WithMany("Images")
                        .HasForeignKey("ProductId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
